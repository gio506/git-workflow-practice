...
This file gives a quick purpose for each key file/folder in this repo.

## Root files

- `README.md` - Main learning guide for workflow, PR flow, tags, and CI.
- `CHEATSHEET.md` - Fast command reference for daily Git use.
- `FILES_EXPLAINED.md` - This map of repository content.
...
- `examples/project-log.txt` - Tiny sample file for commit practice.
